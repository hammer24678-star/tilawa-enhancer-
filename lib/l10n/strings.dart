class S {
  ...
  // Welcome
  String get welcomeTitle   => ar ? 'أهلاً بك' : 'Welcome';
  String get welcomeDesc    => ar
      ? 'محسِّن التلاوة يرفع جودة تلاوات القرآن الكريم إلى مستوى تسجيلات الشيخ ياسر الدوسري 1425هـ'
      : 'Tilawa Enhancer elevates Quran recitation quality to match Sheikh Yasser Al-Dossari\'s 1425H recordings';
  String get welcomeStart   => ar ? 'ابدأ' : 'Get Started';
  String get welcomeHowTitle => ar ? 'كيف يعمل؟' : 'How it works';
  String get step1          => ar ? 'اختر الملف الصوتي' : 'Choose an audio file';
  String get step2          => ar ? 'اختر المحرك المناسب' : 'Choose the right engine';
  String get step3          => ar ? 'انتظر المعالجة' : 'Wait for processing';
  String get step4          => ar ? 'حمّل الملف المحسَّن' : 'Download the enhanced file';
  ...
  String get fileSizeLimit  => ar ? 'MP3 - WAV - M4A - حتى 300MB' : 'MP3 - WAV - M4A - up to 300MB';
  String get chunkedBadge   => ar ? 'رفع مجزأ' : 'Chunked';
  String get done           => ar ? 'اكتملت' : 'Done';
  String get history        => ar ? 'سجل الملفات المعالجة' : 'Processing History';
  String get savedTo        => ar ? 'محفوظ في Downloads' : 'Saved to Downloads';
  String get donation       => ar ? 'صدقة جارية' : 'Donate';
  String get donationDesc   => ar ? 'ساهم في مشروع تحسين التلاوة' : 'Support the Tilawa project';
  ...
  String get enginesHistory => ar ? 'تاريخ المحركات' : 'Engine History';
  String get about          => ar ? 'عن التطبيق' : 'About';
  String get version        => ar ? 'الإصدار 2.0' : 'Version 2.0';
  String get target         => ar ? 'الهدف: LUFS=-6.29 | RMS=-10.01 | Crest=10.25 | LRA=4.19'
